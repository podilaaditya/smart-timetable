 ...
 * Original file: C:\\Users\\solbox\\Documents\\workspace\\SmartTimeTable\\src\\com\\android\\internal\\telephony\\ITelephony.aidl
 */
...
static final int TRANSACTION_getActivePhoneType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_getCdmaEriIconIndex = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getCdmaEriIconMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_getCdmaEriText = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_getCdmaNeedsProvisioning = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_getVoiceMessageCount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_getNetworkType = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_hasIccCard = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
}
/**
     * Dial a number. This doesn't place the call. It displays
     * the Dialer screen.
